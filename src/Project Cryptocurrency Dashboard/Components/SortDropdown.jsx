...
const SortDropdown = ({Dropdown,setDropDown}) => {
  ...
  return (
    <div>
            <select className='w-40 border p-2 border-gray-300 rounded-lg text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500' value={Dropdown} onChange={(e) => setDropDown(e.target.value)}>
